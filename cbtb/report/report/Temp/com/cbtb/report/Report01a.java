...
public class Report01a extends HttpServlet {
  ...
  */
//    whereString="COMPANY_PROFILE.COMPANY_STATUS='"+CbtbConstant.COMPANY_REGISTRATION_IN_PROGRESS+"' AND DOCUMENT_RECEIVING_STATUS.RECEIVING_STATUS (+)= '0'";
    whereString="";
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      if (spec == null) {
            spec = new ReportSpec("cbt", "report01a.cls", ReportSpec.PDF, ReportSpec.EN, ReportSpec.UTF8,whereString);
      }
