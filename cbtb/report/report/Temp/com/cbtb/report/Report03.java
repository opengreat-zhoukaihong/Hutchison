...
public class Report03 extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      whereString="MATCH_CAPACITY_REQUEST.MATCH_STATUS='"+CbtbConstant.MATCH_STATUS_CONFIRM+"'"; //status='2'; Confirmed
      String deliveryDate;
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      if (spec == null) {
            spec = new ReportSpec("cbt", "report03.cls", ReportSpec.PDF, ReportSpec.EN, ReportSpec.UTF8,whereString);
      }
