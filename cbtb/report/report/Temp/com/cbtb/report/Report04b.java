...
public class Report04b extends HttpServlet {
  ...
  /**
   * Init where condition :request_status='CONTAINER_PICKUP' & Destination City =HK  for O/B
  */
      whereString="MC.MATCH_STATUS='"+ CbtbConstant.MATCH_STATUS_CONTAINER_PICKUP+"' AND DR.DESTINATION_CITY_ID='"+CbtbConstant.HONGKONG_CITY_ID+"'";
      String deliveryDate;
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      spec.getParameters().put("title", "Container picked up but not not delivered for O/B");
