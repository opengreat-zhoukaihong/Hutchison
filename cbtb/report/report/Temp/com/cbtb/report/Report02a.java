...
public class Report02a extends HttpServlet {
  ...
  /**
   * Init where condition :request_status='POST' & Origin City =HK  for I/B
  */
      whereString="DELIVERY_REQUEST.REQUEST_STATUS='"+ CbtbConstant.DELIVERY_REQUEST_POST+"' AND DELIVERY_REQUEST.ORIGIN_CITY_ID='"+CbtbConstant.HONGKONG_CITY_ID+"'";
      String startDate;
      String endDate;
...
//          whereString=whereString+" AND DELIVERY_REQUEST.ORIGIN_CITY_ID='"+originCityID+"'";
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      spec.getParameters().put("title", "Origin City:");
