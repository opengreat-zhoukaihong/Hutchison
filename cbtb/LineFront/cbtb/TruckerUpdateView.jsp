...
{
%>
<a href="TruckerEdit.jsp?companyId=<%=companyId%>&truckerId=<%=truckerId%>&back=reg"><font
color="#003366" face="Arial, Helvetica, sans-serif">更新</font></a> |
<%}%>
...
rId=dbList.getReasonCodeDesc(rId,language);
%>
<%=rId%>
</td>
        <td>&nbsp;</td>
