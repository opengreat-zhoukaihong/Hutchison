...
function doPost()
{
   if (frmEdit.tradingPartnerId.value =="")
   {
     alert("貿易夥伴編號不能為空!");
     frmEdit.tradingPartnerId.focus();
     return;
   }
...
<hr>
  ...
  <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td height="30"> <a href="javascript:doPost()"><img src="../images/submit.jpg" width="44" height="19" border="0"></a><img src="../images/good.jpg" width="10" height="10"><a href="javascript:frmEdit.reset()"><img src="../images/reset.jpg" width="44" height="19" border="0"></a> 
      </td>
    </tr>
  </table>
</form>
