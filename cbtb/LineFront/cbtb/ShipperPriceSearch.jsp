 ...
 * AmendId:02
 * Reason03:the errorpage must import
 * AmendId:03
 */
--%>
...
function doPost()
{
  searchFrm.action = "ShipperPriceSearch.jsp";
  searchFrm.submit();
}
</script>
</head>
...
<form action="ShipperPriceSearch.jsp" name="searchFrm">
    ...
    <tr>
      ...
      <td width="16%" height="20"> 
       <a href="javascript:doPost()">
              <img src="../images/search.jpg" width="44" height="19" border="0"></a><img src="../images/good.jpg" width="10" height="10"><a href="javascript:searchFrm.reset()"><img src="../images/reset.jpg" width="44" height="19" border="0"></a>
      </td>
    </tr>
  </table>
...
*/
%>
   <td align="center"><%=(dpfm.ibPriceToShipper==null || dpfm.ibPriceToShipper.toString().equals("0")) ?"":dpfm.ibPriceToShipper.toString()%></td>
   <td align="center"><%=(dpfm.obPriceToShipper==null || dpfm.obPriceToShipper.toString().equals("0")) ?"":dpfm.obPriceToShipper.toString()%></td>
<%
/**
*AmendId:02
*/
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" height="22">
      <tr>
        <td width="76%" class="unnamed1">
          ...
          {
            %>
          &nbsp;&nbsp<a href="ShipperPriceSearch.jsp?type=F&init=p" class="unnamed1"><img src="../images/firstpage.JPG" width="10" height="10" alt="第一頁" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp<a href="ShipperPriceSearch.jsp?type=P&init=p"><img src="../images/perviouspage.jpg" width="8" height="10" alt="上一頁" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <%
          }
          if (newPagination.getPageNo() < newPagination.getPageSum())
          {
            %>
          &nbsp;&nbsp;<a href="ShipperPriceSearch.jsp?type=N&init=p"><img src="../images/nextpage.jpg" width="8" height="10" alt="下一頁" border="0"></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a href="ShipperPriceSearch.jsp?type=E&init=p"><img src="../images/endpage.jpg" width="10" height="10" alt="最後一頁" border="0"></a>
          <%
          }
          %>
          </td>
