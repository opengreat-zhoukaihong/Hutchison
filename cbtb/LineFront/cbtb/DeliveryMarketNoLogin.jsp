...
<jsp:useBean id="webOperator" scope="application" class="com.cbtb.web.WebOperator"/>
<html>
<head>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td>
      <div align="right"><a href="index.jsp"><font
color="#003366">關閉</font></a></div>
    </td>
  </tr>
</table>
<form method="post"  name = "search" action="DeliveryMarketNoLogin.jsp">
<input type="hidden" name="init" value="notfirst">
  ...
  <table border="0" width="98%" cellpadding="0" cellspacing="0" align="center">
    ...
    <td><font size="2">日期： </font></td>
         <td ><input type="text" maxlength="10" size="10" value="<%=request.getParameter("deliveryDate")%>" name="deliveryDate"  >
        ...
        <td><font size="2"> <select name="timeId">
              <%=dbList.getDeliveryTimeList(request.getParameter("timeId"),sMarkLanguage)%>
            </select></font>
       </td>
    </tr>
    <tr>
    ...
    <td><font size="2">貨櫃種類：</font></td>
       <td>
        ...
        <%=dbList.getContainerTypeList(request.getParameter("containerId"),sMarkLanguage)%>
        </select>
        </td>
    ...
    <table width="90%"  cellspacing="0" cellpadding="4" align="center">
       <tr>
          ...
          <%
            ...
            {
          %>
             <a href="DeliveryMarketNoLogin.jsp?type=F&init=tmd"><img src="../images/firstpage.JPG" width="10" height="10" alt="第一頁" border="0"></a>
             <img src="../images/good.jpg" width="20" height="10"><a href="DeliveryMarketNoLogin.jsp?type=P&init=tmd"><img src="../images/perviouspage.jpg" width="8" height="10" alt="上一頁" border="0"></a>
          <%
           }
           if (newPagination.getPageNo() < newPagination.getPageSum())
           {
         %>
            <img src="../images/good.jpg" width="20" height="10"><a href="DeliveryMarketNoLogin.jsp?type=N&init=tmd"><img src="../images/nextpage.jpg" width="8" height="10" alt="下一頁" border="0"></a><img src="../images/good.jpg" width="20" height="10"><a href="DeliveryMarketNoLogin.jsp?type=E&init=tmd"><img src="../images/endpage.jpg" width="10" height="10" alt="最後一頁" border="0"></a>
        <%
           }
        %>
       </td>
