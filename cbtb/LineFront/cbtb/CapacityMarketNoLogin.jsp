...
AmendDate:  2001/6/22
Author:     Templar_Shu
Reason:     Can't display the Capacity's Company Name.
						Change the truckerId to Hongkong_Plate_No.
AmendId:
*/%>
...
<%@ include file = "../include/top.jsp" %>
  <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      ...
      <td width="57%">
        <div align="right"><a href="index.jsp"><font color="#003366">關閉</font></a></div>
      </td>
    </tr>
  </table>
  <form name="search" method="post" action="CapacityMarketNoLogin.jsp">
...
<table width="98%"  cellspacing="0" cellpadding="4" align="center">
  <tr>
    <td width="84%" class="unnamed1">
      ...
      {
      %>
				<a href="CapacityMarketNoLogin.jsp?type=F&init=1"><img src="../images/firstpage.JPG" width="10" height="10" alt="第一頁" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="CapacityMarketNoLogin.jsp?type=P&init=1"><img src="../images/perviouspage.jpg" width="8" height="10" alt="上一頁" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <%
      }
      if (newPaginationSSY.getPageNo() < newPaginationSSY.getPageSum())
      {
      %>
				<a href="CapacityMarketNoLogin.jsp?type=N&init=1"><img src="../images/nextpage.jpg" width="8" height="10" alt="下一頁" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="CapacityMarketNoLogin.jsp?type=E&init=1"><img src="../images/endpage.jpg" width="10" height="10" alt="最後一頁" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <%
      }
      %>
