...
<%
   ...
   deliveryRequestModel.setCompanyId(companyId);
   ...
   session.setAttribute("deliveryRequestModel",deliveryRequestModel);
...
<%@ include file = "../include/ShiperHead.jsp" %>
  ...
  <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <td width="43%"><font face="Arial, Helvetica, sans-serif" size="2"><font color="#667852"><b>送貨要求細節</b></font></font></td>
      ...
      <div align="right"><a href="DeliveryRequestInsert.jsp?path=<%= request.getParameter("path") %>&mode=<%= request.getParameter("mode") %>"><font
color="#003366">確定</font></a> | <a href="DeliveryRequestInsert.jsp?reAddpath=DeliveryRequestReAdd.jsp&path=<%= request.getParameter("path") %>&mode=<%= request.getParameter("mode") %>"><font
color="#003366">拷貝&繼續</font></a> |<a href="javascript:history.back()"><font
...
<div align="left">
  ...
  <tr> 
    ...
    <tr> 
      ...
      <td width="18%">
          <%
             if(deliveryRequestModel.getRemark().trim().length() > 0)
             {
          %>
                <textarea rows = 5 cols=5 readonly style="font-family: 宋体; font-size: 9pt; border: 1 solid #000000"><%= deliveryRequestModel.getRemark() %></textarea>
          <%
             }
          %>
      &nbsp;</td>
