...
<input type="hidden" name="back" value="<%=back%>">
   <tr>
    ...
    <td>
      <input type="text" size="20" name="truckerName" maxlength="30" tabindex=1 >
    </td>
        <td>香港身份證號碼 / 護照號碼：</td>
        <td><input type="text" size="20" name="hkId" maxlength="10" tabindex=2 > </td>
    </tr>
    <tr>
        <td>貨櫃車司機中文姓名：</td>
        <td><input type="text" size="20" name="truckerChineseName" maxlength="15" tabindex=3 > </td>
        <td>貨櫃車型號：</td>
        <td><input type="text" size="20" name="truckModelNo" maxlength="20" tabindex=4 > </td>
    </tr>
    <tr>
        <td>地址：</td>
        <td><input type="text" size="20" name="truckerAddr1" maxlength="50" tabindex=5> </td>
        <td>顔色：</td>
        <td><input type="text" size="20" name="truckColor" maxlength="10" tabindex=9> </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td><input type="text" size="20" name="truckerAddr2" maxlength="50" tabindex=6></td>
        <td>重量 (公斤)：</td>
        <td><input type="text" size="20" name="carryWeight" maxlength="20" tabindex=10> </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td><input type="text" size="20" name="truckerAddr3" maxlength="50" tabindex=7> </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td><input type="text" size="20" name="truckerAddr4" maxlength="50" tabindex=8> </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>内地車牌號碼：</td>
        <td><input type="text" size="20" name="inlandPlateNo" maxlength="10" tabindex=11 > </td>
        <td>香港車牌號碼：</td>
        <td><input type="text" size="20" name="hkPlateNo" maxlength="10" tabindex=12 > </td>
    </tr>
    <tr>
        <td>内地電話號碼：</td>
    ...
    <tr>
        <td>内地駕駛執照號碼：</td>
        <td><input type="text" size="20" name="inlandLicenseNo" maxlength="10" tabindex=19 > </td>
        <td>香港駕駛執照號碼：</td>
        <td><input type="text" size="20" name="hkLicenseNo" maxlength="10" tabindex=20 > </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    ...
    <tr>
        ...
        <td>備注：</td>
        <td><textarea name="remark" rows="3" cols="18" maxlength="50" tabindex=21 ></textarea></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>    
    </tr>
    <tr>
