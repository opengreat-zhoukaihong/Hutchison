...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <td width="43%"><font face="Arial, Helvetica, sans-serif" size="2"><font color="#667852"><b>貿易夥伴數據維護</b></font></font></td>
      <td width="57%"> 
      <div align="right"><a href="TradingPartnerInsert.jsp?action=<%=request.getParameter("action")%>&path=<%= request.getParameter("path") + "?rootPath=" + request.getParameter("rootPath") %>"><font
