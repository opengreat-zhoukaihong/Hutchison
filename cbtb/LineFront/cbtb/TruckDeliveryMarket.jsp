...
<form method="post"  name = "search" action="TruckDeliveryMarket.jsp">
    ...
    <table width="90%"  cellspacing="0" cellpadding="4" align="center">
       <tr>
          ...
          <%
            ...
            {
          %>
             <a href="TruckDeliveryMarket.jsp?type=F&init=tmd"><img src="../images/firstpage.JPG" width="10" height="10" alt="第一頁" border="0"></a>
             <img src="../images/good.jpg" width="20" height="10"><a href="TruckDeliveryMarket.jsp?type=P&init=tmd"><img src="../images/perviouspage.jpg" width="8" height="10" alt="上一頁" border="0"></a>
          <%
           }
           if (newPagination.getPageNo() < newPagination.getPageSum())
           {
         %>
            <img src="../images/good.jpg" width="20" height="10"><a href="TruckDeliveryMarket.jsp?type=N&init=tmd"><img src="../images/nextpage.jpg" width="8" height="10" alt="下一頁" border="0"></a><img src="../images/good.jpg" width="20" height="10"><a href="TruckDeliveryMarket.jsp?type=E&init=tmd"><img src="../images/endpage.jpg" width="10" height="10" alt="最後一頁" border="0"></a>
        <%
           }
        %>
       </td>
