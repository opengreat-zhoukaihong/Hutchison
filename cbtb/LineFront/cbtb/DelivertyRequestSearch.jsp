...
<%
   ...
   if(companyName == null){
      companyName = dbList.getContainerTypeDesc(companyId,sMarkLanguage);
   }
...
<form name="add" action="DelivertyRequestSearch.jsp" method="post">
...
<table border="0" align="center" width="98%"  cellpadding="1" cellspacing="1">
  ...
  <tr>
    ...
    <td><select name="deliveryTime" size="1">
              <%= dbList.getDeliveryTimeList(request.getParameter("deliveryTime"),sMarkLanguage) %>
        </select>
    </td>
    <td>目的地城市：</td>
  ...
  <tr>
    ...
    <td><select name="requestStatus" size="1">
            <%= dbList.getDeliveryStatusList(request.getParameter("requestStatus"),sMarkLanguage) %>
        </select>
    </td>
    <td width="17%">貨櫃種類： </td>
    <td><select name="containerTypeId" size="1">
           <%= dbList.getContainerTypeList(request.getParameter("containerTypeId"),sMarkLanguage) %>
        </select>
    </td>
    <td></td>
    <td></td>
  ...
  <tr>
    <td colspan="2" width="22%"> <a href="Registration_edit.htm"><font color="#003366"
        size="2" face="Arial, Helvetica, sans-serif"> </font></a><font color="#003366" size="2"
        face="Arial, Helvetica, sans-serif"><a href="javascript:add.submit()"><img src="../images/search.jpg" width="44" height="19" border="0"></a><img src="../images/good.jpg" width="10" height="10"><a href="javascript:add.reset();"><img src="../images/reset.jpg" width="44" height="19" border="0"></a>
      </font>
   </td>
    <td width="30%">&nbsp; </td>
    <td width="17%">&nbsp;</td>
  ...
  <%
    ...
    try{
	   ...
	   orderByName = request.getParameter("orderByName");
            ...
            newPagination.setRecords((Collection)webOperator.getCompanyManager().searchDeliveryRequest(null,null,null,originCityId,null,destinationCityId,requestStatus,containerTypeId,deliveryDate,null,deliveryTime,null,null, orderByName));
   //   newPagination.setRecords((Collection)webOperator.getCompanyManager().searchDeliveryRequest(null,null,null,null,null,null,null,null,null,null,null,null,null, null));
	...
	<td height="28"><%= deliveryRequestModelList.getSubMissionDatetime().toString().substring(0,10) %>&nbsp;</td>
        <td><a href="DeliveryRequestView.jsp?path=DelivertyRequestSearch.jsp&deliveryRequestNum=<%= RequestNum  %>&companyId=<%= companyId %>&companyName=<%= companyName %>&rootPath=<%= rootPath %>"><font color="#003366"><%= RequestNum  %></font></a></td>
  ...
  <tr>
     <td width="84%" class="unnamed1">
        <%
          ...
          {
        %>
           <a href="DelivertyRequestSearch.jsp?type=F&init=tmd"><img src="../images/firstpage.JPG" width="10" height="10" alt="第一頁" border="0"></a>
           <img src="../images/good.jpg" width="20" height="10"><a href="DelivertyRequestSearch.jsp?type=P&init=tmd"><img src="../images/perviouspage.jpg" width="8" height="10" alt="上一頁" border="0"></a>
        <%
          }
          if (newPagination.getPageNo() < newPagination.getPageSum())
          {
       %>
           <img src="../images/good.jpg" width="20" height="10"><a href="DelivertyRequestSearch.jsp?type=N&init=tmd"><img src="../images/nextpage.jpg" width="8" height="10" alt="下一頁" border="0"></a><img src="../images/good.jpg" width="20" height="10"><a href="DelivertyRequestSearch.jsp?type=E&init=tmd"><img src="../images/endpage.jpg" width="10" height="10" alt="最後一頁" border="0"></a>
       <%
          }
       %>
    </td>
