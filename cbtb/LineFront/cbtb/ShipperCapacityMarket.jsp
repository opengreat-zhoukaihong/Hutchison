...
{
 search.check.value="1";
 }
function doPost(i)
{
  if(i==2)
  {
    if(search.check.value!="1")
    {
     alert("請選擇要配對的紀錄！");
     return;
     }
    search.action="MatchDeliveryList.jsp"
  }
  if(i==1)
   {
   ...
   search.action="ShipperCapacityMarket.jsp"
   }
	search.submit();
}
</SCRIPT>
  ...
  <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td width="43%"><font face="Arial, Helvetica, sans-serif" size="2"><b><font color="#667852">空車市集</font></b></font></td>
       <td width="57%">
        <div align="right"><a href="javascript:doPost(2)"><font color="#003366">配對</font></a>&nbsp;|&nbsp;<a href="indexShipping.jsp"><font color="#003366">關閉</font></a></div>
      </td>
    </tr>
  </table>
  <form name="search" method="post" action="ShipperCapacityMarket.jsp">
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td width="376">
          <select name="containerType" size="1">
						<%=dbList.getContainerTypeList(request.getParameter("containerType"),language)%>
					</select>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="123">
          ...
          <input type="hidden" name="init" value="notFirst">
					<a href="javascript:doPost(1)"><img src="../images/search.jpg" width="44" height="19" border="0"></a>
...
if (type==null)
{
	if(init!=null)
	{
		...
		newPaginationSSY.setRecords(companyManager.searchTruckCapacityByContainer(truckCapacityNum,null,null,
...
{
	//newPaginationSSY = (NewPagination)session.getAttribute("CapacityMarketPagination");
...
<table cellpadding="4" cellspacing="" width="98%" align="center">
  <tr bgcolor="e0e0e0">
    ...
    %>
		...
		%>
			<td>
				<input type = "radio" name = "truckCapacityNum" onClick="JavaScript:radioClicked()" value="<%=truckCapacityModel.getTruckCapacityNum()%>">
			</td>
			<td><%=dbList.getTruckCapacityStatusDesc(truckCapacityModel.getTruckCapacityStatus(),language)%></td>
		<%
		}
		CompanyManager companyManager =  webOperator.getCompanyManager();   //AmondId:
		%>
...
<table width="98%"  cellspacing="0" cellpadding="4" align="center">
  <tr>
    <td width="84%" class="unnamed1">
      ...
      {
      %>
				<a href="ShipperCapacityMarket.jsp?type=F&init=1"><img src="../images/firstpage.JPG" width="10" height="10" alt="第一頁" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="ShipperCapacityMarket.jsp?type=P&init=1"><img src="../images/perviouspage.jpg" width="8" height="10" alt="上一頁" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <%
      }
      if (newPaginationSSY.getPageNo() < newPaginationSSY.getPageSum())
      {
      %>
				<a href="ShipperCapacityMarket.jsp?type=N&init=1"><img src="../images/nextpage.jpg" width="8" height="10" alt="下一頁" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="ShipperCapacityMarket.jsp?type=E&init=1"><img src="../images/endpage.jpg" width="10" height="10" alt="最後一頁" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <%
      }
      %>
