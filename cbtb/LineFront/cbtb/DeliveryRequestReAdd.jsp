...
{   
 ...
 function cargoIssuer_onchange() {
   ...
   add.action = "DeliveryRequestReAdd.jsp#3";
   add.submit();
 }
...
<form action="DeliveryRequestConfirm.jsp" name="add" method = "post">
  <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr> 
      ...
      <div align="right"><a href="<%=request.getParameter("path")%>?rootPath=indexShipping.jsp"><font
...
<a name="3">
   ...
   <tr> 
        <td>備注：</td>
        <td height="110"> 
          <textarea  rows="5" cols="15" style="width:200px" name="remark"><%= deliveryRequestMode.getRemark() %></textarea>
        </td>
        <td>&nbsp;</td>
        <td>&nbsp; </td>
    </tr>
...
<a name="3">
    <tr> 
      ...
      <td height="20"> 
        <select name="cargoIssuer" size="1"  LANGUAGE=javascript  onchange="return cargoIssuer_onchange()">
             <%= dbList.getTradingPartnerList(request.getParameter("companyId"),request.getParameter("cargoIssuer"),sMarkLanguage) %>
        </select>
        <%= redStarLeft%>
      </td>
      <td height="20"></td>
      <td height="20">
        <select name="cargoReceiver" size="1" LANGUAGE=javascript  onchange="return cargoReceiver_onchange()">
            <%= dbList.getTradingPartnerList(request.getParameter("companyId"),request.getParameter("cargoReceiver"),sMarkLanguage) %>
        </select>
        <%= redStarRight %>
      </td>
    </tr>
