...
<%
		...
		try {
			...
			userPK = request.getParameter("uid");
			if (userPK == null)	userPK = currUserID + "/" + currUserOrgID;

			userObj = adaptor.getUser( currUserID, userPK );
%> 
<h2 align="center">User Profile for <%=userPK%></h2>
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  <tr valign="top"> 
    <td> 
      <div align="right"><b> <%=userObj.toString( "</td></tr><tr valign=top><td><div align=right><b>", " : <b></div></td><td><div>")%> 
      </div>
    </td>
    <td>&nbsp;</td>
  </tr>
