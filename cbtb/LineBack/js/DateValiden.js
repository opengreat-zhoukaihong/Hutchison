...
function checkDate(elemYear,elemMonth,elemDay)
{
   ...
   {
	error(elemMonth,"Incorrect month");
	return false;
   }//end if

   if(!ValidDay(elemDay)) 
   {
	error(elemDay,"Incorrect Day")
	return false;
   }
  ...
  if (month==4||month==6||month==9||month==11)
  {
    if (day>30)
    {
      error(elemDay,"Day number must be less than 31" )
      return false;
    }//end if
  }
  else if (month==2)
  { 
    ...
    { 
      if (day<1||day>29)
      {
        error(elemDay," Day number must be less than 30" )
        return false;
      }//end if
    } 
    else						//平年
    { 
      if (day>28) 
      {
        error(elemDay," Day number must be less than 29" )
        return false;
      }//end if
    }
}
...
function checkDateWithOneElem(elem)
{
  ...
  {
    error(elem,"Incorrect Year！");
    return false;
  }
  if (month<1||month>12)
  {
    error(elem,"Incorrect month！");
    return false;
  }
  if (month==1||month==3||month==5||month==7||month==8||month==10||month==12)
  {
    if (day<1||day>31)
    {
      error(elem,"Day number must me 1-31 ！");
      return false;
    }
  }
  else if (month==2)
  { 
    ...
    { 
      if (day<1||day>29)
      {
        error(elem,"Day number must be 1-29");
        return false;
      }
    } 
    else
    { 
      if (day<1||day>28) 
      {
        error(elem,"Day number must be 1-28");
        return false;
      }
    }
  }
  else
  {
    if (day<1||day>30)
    {
      error(elem,"Day number must be 1-30");
      return false;
    }
  }
  return true;
