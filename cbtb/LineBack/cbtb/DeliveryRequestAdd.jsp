...
<%
  ...
  if (webOperator.checkPermission())
   ...
   String redStarInTextBox = "";  //if the company have no trading partner
   String redStar = "";
   if ((dbList.getTradingPartnerList(companyProfileModel.getCompanyId(),deliveryRequestMode.getCargoReceiver(),sMarkLanguage)).indexOf("value",10) == -1)
      redStarInTextBox = "<font color=#ff0033>*</font>";
   else
        redStar = "<font color=#ff0033>*</font>";
%>
<html>
<head>
...
{   
 ...
 function cargoQty_onchange(){
   ...
   if(!isFloat(RemoveSpace(inputvar),obj,"貨物數量只能輸入數字!")){
      obj.focus();
      return false;
   }
 }
 ...
 function cargoIssuer_onchange() {
   ...
   add.action = "DeliveryRequestAdd.jsp#3";
   add.submit();
 }
...
color="#003366"><a href="javascript:history.back()">關閉</a></font></div>
    </td>
  </tr>
</table>
<table width="75%" border="0" cellspacing="0" cellpadding="0">
...
<input type="hidden" name="path" value = "self">
<imput type="hidden" name="companyId" value ="<%= request.getParameter("companyId") %>">
...
<%
   System.out.println("CompanyId is : " +  companyProfileModel.getCompanyId());
   System.out.println("CompanyChineseName is : " +  companyProfileModel.getCompanyChineseName());
%>
...
<input type="hidden" name="path" value="searchCompanyShipper">
<table width="75%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td><img src="../images/good.jpg" width="10" height="10"></td>
  </tr>
  ...
  <table border="0" width="75%">
   ...
   %>
      <tr> 
        ...
        <td height="20"> 
            <input type="text" maxlength="50" size="20" name="cargoIssuerInput"><%= redStarInTextBox %>
        </td>
        <td height="20">收貨公司名稱：</td>
        <td height="20">
            <input type="text" maxlength="50" size="20" name="cargoReceiverInput"><%= redStarInTextBox %>
        </td>
     </tr>
   <%
   }
...
%>
    <tr> 
      <td>發貨公司聯絡人電話號碼：</td>
      <td> 
          </a><input type="text" maxlength="20" size="20" name="cargoIssuerPhoneNo"><font color=#ff0033>*</font>
      </td>
      <td>收貨公司聯絡人電話號碼：</td>
      <td> 
...
<%
 ...
 %>  
    ...
    <tr>
        <td>備注：</td>
        <td colspan="3"> 
           <textarea maxlength="200" size="20" cols="80" name="remark"><%= request.getParameter("remark") %></textarea>
        </td>
    </tr>
  </table>
</div>  
