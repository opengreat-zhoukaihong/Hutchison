...
String language = "CH";
session.getAttribute("truckCapacityModel");
%>
<SCRIPT LANGUAGE=javascript>
function doPost()
{
	if (updateStatus.truckCapacityStatus.value=="Any")
	{
		alert("請輸入狀態！");
		return;
	}
...
<BR>
<div align="left">
<form name="updateStatus" method="post" action="CapacityStatusUpdateConfirm.jsp">
  <table border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="56%">狀態：</td>
      <td width="56%">
        <select name="truckCapacityStatus">
					<option value="<%=com.cbtb.util.CbtbConstant.TRUCK_CAPACITY_POST%>"><%=dbList.getTruckCapacityStatusDesc(com.cbtb.util.CbtbConstant.TRUCK_CAPACITY_POST,language)%></option>
					<option value="<%=com.cbtb.util.CbtbConstant.TRUCK_CAPACITY_CANCEL%>"><%=dbList.getTruckCapacityStatusDesc(com.cbtb.util.CbtbConstant.TRUCK_CAPACITY_CANCEL,language)%></option>
        </select>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="0%" height="11"><%=truckCapacityModel.getDeliveryDate().toString().substring(0,10)%></td>
	...
	<BR>
	<input type="hidden" name="URL" value="CapacityStatusUpdate.jsp">
