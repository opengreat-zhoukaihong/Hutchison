...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <td width="43%"><font face="Arial, Helvetica, sans-serif" size="2">貿易夥伴數據維護</font></td>
      ...
      <div align="right"><a
href="Trading_Partner_search.htm"></a><a href="TradingPartnerDelete.jsp?tradingPartnerId=<%= tradingPartnerValue.tradingPartnerId %>&path=<%= request.getParameter("path") + "?companyId=" + tradingPartnerValue.companyId  %>"><font 
