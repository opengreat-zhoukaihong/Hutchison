...
function postForm()
{
   deDate=report03.deliveryDate.value;
   tiID=report03.deliveryTimeID.value;
   user="<%=userId%>"; 
   window.open("/servlets/com.cbtb.report.Report03?dd="+deDate+"&ti="+tiID+"&user="+user,null, "height=550,width=800,top=0,left=0,scrollbars=yes");
}
</script>
