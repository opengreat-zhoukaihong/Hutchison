...
if (!webOperator.checkPermission())
  response.sendRedirect("ErrorPage.jsp?Message=ER_9000");
%>
...
function postForm()
{
   ...
   dcID=report02.destinationCityID.value;
   no=report02.deliveryRequestNo.value;
   window.open("/servlets/com.cbtb.report.Report02?sd="+sDate+"&ed="+eDate+"&ti="+tiID+"&oc="+ocID+"&dc="+dcID+"&no="+no,null, "scrollbars=yes");
}
</script>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td><font face="Arial, Helvetica, sans-serif" size="3">
          Not Match Delivery Request Number List
	</font>
    </td>
    <td>
