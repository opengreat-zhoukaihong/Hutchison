...
<p align="right"> <a href="CargoCategoryEdit.jsp?cargoId=<%=request.getParameter("cargoId")%>"><font
color="#003366" size="2" face="Arial, Helvetica, sans-serif">更新</font></a>
  | <a href="CargoCategoryDelView.jsp?cargoId=<%=request.getParameter("cargoId")%>"><font
...
<table width="56%" border="0">
  <tr>
    <td width="50%">編號：</td>
    <td width="50%" ><%=request.getParameter("cargoId")%></td>
  </tr>
  <tr>
    <td width="50%">英文描述：</td>
