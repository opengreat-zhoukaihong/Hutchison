...
<p align="right"> <a href="ShippingLineEdit.jsp?shippingLineId=<%=request.getParameter("shippingLineId")%>"><font
color="#003366" size="2" face="Arial, Helvetica, sans-serif">更新</font></a>
  | <a href="ShippingLineDelView.jsp?shippingLineId=<%=request.getParameter("shippingLineId")%>"><font
