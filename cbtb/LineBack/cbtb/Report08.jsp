...
function postForm()
{
   sDate=report08.startDate.value;
   eDate=report08.endDate.value;
   tiID=report08.deliveryTimeID.value;
   ocID=report08.originCityID.value;
   dcID=report08.destinationCityID.value;
   no=report08.truckCapacityNo.value;
   user="<%=userId%>"; 
   window.open("/servlets/com.cbtb.report.Report08?sd="+sDate+"&ed="+eDate+"&ti="+tiID+"&oc="+ocID+"&dc="+dcID+"&no="+no+"&user="+user,null, "height=550,width=800,top=0,left=0,scrollbars=yes");
}
</script>
...
<table border="0" width="100%">
	...
	<select name="destinationCityID" size="1">
     ...
     <td width="12%"><input type="text" size="10" name="truckCapacityNo" maxlength="12"></td>
     </tr>
     <tr>
