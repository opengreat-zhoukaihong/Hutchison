...
function postForm()
{
   deDate=report04a.deliveryDate.value;
   tiID=report04a.deliveryTimeID.value;
   user="<%=userId%>"; 
   window.open("/servlets/com.cbtb.report.Report04a?dd="+deDate+"&ti="+tiID+"&user="+user,null, "height=550,width=800,top=0,left=0,scrollbars=yes");
}
</script>
