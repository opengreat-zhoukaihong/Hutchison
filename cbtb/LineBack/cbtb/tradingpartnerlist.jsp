...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <td width="43%"><font face="Arial, Helvetica, sans-serif" size="2">貿易夥伴數據維護</font></td>
      <td width="57%"> 
      <div align="right"><a href="TradingPartnerAdd.jsp?companyId=<%= companyId %>&path=<%= path %>"><font
...
face="Arial, Helvetica, sans-serif"> </font><font color="#003366" size="2"
face="Arial, Helvetica, sans-serif"> | </font><a href="UserSearchCompanyShipper.jsp?companyId=<%=companyId%>"><font color="#003366"
...
<table border="0" width="98%" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr> 
    ...
    <td>
      <div align="left"></div>
      <p> 
        <input type="submit" name="denglu  3" value="提 交">
...
%>
<table  border="1" cellpadding="0" cellspacing="2" width="100%" align="center">
  <tr> 
    <td width="15%">狀況&nbsp;&nbsp;</td>
...
<table width="750" border="0" cellspacing="0" cellpadding="0" height="22">
      <tr>
        <td width="75%" class="unnamed1">&nbsp;&nbsp; 
          ...
          {
            %>
          <a href="TradingPartnerList.jsp?type=F&init=tmd&companyId=<%=companyId%>" class="unnamed1">第一頁</a>&nbsp;<a href="TradingPartnerList.jsp?type=P&init=tmd&companyId=<%=companyId%>">前一頁</a> 
          <%
          }
          if (pagination.getPageNo() < pagination.getPageSum())
          {
            %>
          &nbsp;<a href="TradingPartnerList.jsp?type=N&init=tmd&companyId=<%=companyId%>">後一頁</a>&nbsp;<a href="TradingPartnerList.jsp?type=E&init=tmd&companyId=<%=companyId%>">最後一頁</a> 
          <%
          }
          %>
          </td>     
