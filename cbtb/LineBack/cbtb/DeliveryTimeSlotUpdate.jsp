...
<%
  ...
  if (deliveryTimeSlotBean.deliveryTimeSlotUpdate(arrayData)){
      dbList.loadDeliveryTimeSlotList();
      backPageName = "SuccessPage.jsp?backPage=DeliveryTimeSlotList.jsp&mode=Update";
  }
  else
     backPageName = "ErrorPage.jsp?backPage=DeliveryTimeSlotList.jsp&mode=Update";
%>
