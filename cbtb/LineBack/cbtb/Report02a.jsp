...
function postForm()
{
   ...
   user="<%=userId%>"; 
   window.open("/servlets/com.cbtb.report.Report02a?sd="+sDate+"&ed="+eDate+"&ti="+tiID+"&dc="+dcID+"&no="+no+"&user="+user,null, "height=550,width=800,top=0,left=0,scrollbars=yes");
}
</script>
