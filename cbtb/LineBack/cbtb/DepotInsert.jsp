...
<%
  ...
  String backPageName = "";
  if (depotBean.depotInsert(depotData))
    {
    dbList.loadDepotList();
    backPageName = "SuccessPage.jsp?backPage=DepotList.jsp&mode=Insert";}
  else{
    backPageName = "ErrorPage.jsp?backPage=DepotList.jsp&mode=Insert";}
%>
