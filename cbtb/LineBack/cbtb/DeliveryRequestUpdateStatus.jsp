...
<%
   ...
   String deliveryRequestNum="",companyProfile="";
...
<form action="DeliveryRequestConfirmStatus.jsp?deliveryRequestNum=<%= deliveryRequestMode.getDeliveryRequestNum() %>" method="POST" name="add">
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    ...
    <td height="11"> 
      <div align="right"><font color="#003366" face="Arial, Helvetica, sans-serif"><a href="javascript:history.back()">取消</a></font></div>
    </td>
  </tr>
</table>
<table width="75%" border="0" cellspacing="0" cellpadding="0">
...
<div align="left">
  ...
  <table border="0" width="75%">
    ...
    <tr> 
      <td width="38%">狀態:</td>
      <td width="12%">
          <select name="requestStatus" size="1">
            <option value="<%= cbtbConstant.DELIVERY_REQUEST_POST %>"><%= dbList.getDeliveryStatusDesc(cbtbConstant.DELIVERY_REQUEST_POST,sMarkLanguage) %></optioin>
            <option value="<%= cbtbConstant.DELIVERY_REQUEST_CANCEL %>"><%= dbList.getDeliveryStatusDesc(cbtbConstant.DELIVERY_REQUEST_CANCEL,sMarkLanguage) %></optioin>
          </select>
      </td>
      <td width="32%">運價：</td>
   ...
   <p><input type="submit" name="deng" value="提 交" >&nbsp;&nbsp;<input type="reset" name="B1" value="清除">  </p>
</form>
