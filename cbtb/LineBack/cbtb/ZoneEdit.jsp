...
<p align="right"><a
href="ZoneView.jsp?zoneId=<%=request.getParameter("zoneId")%>&zoneDesc=<%=request.getParameter("zoneDesc")%>&chineseDesc=<%=request.getParameter("chineseDesc")%>"><font color="#003366" size="2"
face="Arial, Helvetica, sans-serif">取消</font></a></p>
<p><font face="Arial, Helvetica, sans-serif" size="3">區域數據維護</font></p>

<hr>
<form action="ZoneConfirm.jsp" name="add" method="POST">
...
%>
  ...
  <tr> 
    <td width="50%">英文描述：</td>
    <td width="50%"> 
      <input type="text" maxlength="20" size="20" name="zoneDesc" value="<%=dbList.getZoneDesc(zoneId, "EN")%>">
    </td>
  </tr>
  <tr> 
    <td width="50%">中文描述：</td>
    <td width="50%"> 
      <input type="text" maxlength="10" size="20"  name="chineseDesc"value="<%=dbList.getZoneDesc(zoneId, "CN")%>">
    </td>
  </tr>
</table>
<p>&nbsp;</p>
