...
function postForm()
{
   deDate=report07.deliveryDate.value;
   tiID=report07.deliveryTimeID.value;
   user="<%=userId%>"; 
   window.open("/servlets/com.cbtb.report.Report07?dd="+deDate+"&ti="+tiID+"&user="+user,null, "height=550,width=800,top=0,left=0,scrollbars=yes");
}
</script>
