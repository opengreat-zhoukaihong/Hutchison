...
<%
  ...
  if (deliveryTimeBean.deliveryTimeInsert(arrayData)){
     dbList.loadDeliveryTimeList();
     backPageName = "SuccessPage.jsp?backPage=DeliveryTimeList.jsp&mode=Insert";
  }
  else
     backPageName = "ErrorPage.jsp?backPage=DeliveryTimeList.jsp&mode=Insert";
%>
