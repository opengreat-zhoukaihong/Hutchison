...
if (containerTypeBean.containerTypeInsert(containerTypeData))
    {backPageName = "SuccessPage.jsp?backPage=ContainerTypeList.jsp&mode=Insert";
    dbList.loadContainerTypeList();}
  else
    backPageName = "ErrorPage.jsp?errorMassage=ER_0001";
%>
