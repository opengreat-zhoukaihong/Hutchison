...
<%
  ...
  String backPageName = "";
  if (cityBean.cityUpdate(cityData))
    {
      dbList.loadCityList();
      backPageName = "SuccessPage.jsp?backPage=CityList.jsp&mode=Update";
    }
  else
    backPageName = "ErrorPage.jsp?backPage=CityList.jsp&mode=Update";
%>
