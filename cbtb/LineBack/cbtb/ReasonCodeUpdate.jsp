...
<%
  ...
  String backPageName = "";
  if (reasonBean.ReasonCodeUpdate(Data))
	{
		dbList.loadReasonCodeList();
    backPageName = "SuccessPage.jsp?backPage=ReasonCodeList.jsp&mode=Update";
	}
  else
    backPageName = "ErrorPage.jsp?backPage=ReasonCodeList.jsp&mode=Update";
%>
