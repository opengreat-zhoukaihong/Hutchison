...
companyProfileModel=  companyManager.findCompanyProfile(comId);
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td height="11"><font face="Arial, Helvetica, sans-serif">運輸公司註冊信息</font></td>
    <td height="11"> 
      <div align="right"><a
href="RegEdit.jsp?back=reg"><font color="#003366">更新</font></a> |<a href="TruckerAdd.jsp?companyId=<%=comId%>&back=reg"><font
color="#003366">新建司機</font></a><a href="RegistrationSearch.jsp"><font
...
<form  method="post">
  <table border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      ...
      <td>運輸公司</td>
      <td>公司註冊編號/公司編號：</td>
      <td><%=companyProfileModel.getBusiRegistrationNum()%> /<%=comId%></td>
    </tr>
    <tr> 
      <td>公司英文名稱：</td>
...
if(companyProfileModel.getReasonId()==null)
   rId="";
else
