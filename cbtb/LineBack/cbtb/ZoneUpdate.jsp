...
<%
  ...
  if (zoneBean.zoneUpdate(zoneData)){
     dbList.loadZoneList();
     backPageName = "SuccessPage.jsp?backPage=ZoneList.jsp&mode=Update";
  }
  else
     backPageName = "ErrorPage.jsp?backPage=ZoneList.jsp&mode=Update";
%>
