...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td>
      <div align="right"><a
href="MatchFunctionList.jsp"><font color="#003366">關閉</font></a></div>
    </td>
  </tr>
</table>
...
<table width="80%" border="0" cellspacing="0" cellpadding="0" height="22" align="left">
  <tr>
    <td width="28%" class="unnamed1">
          ...
          {
            %>
      <div align="left"><a href="MatchTruck.jsp?type=F&matchInit=tmd"><font color="#003366">第一頁</font></a> <a href="MatchTruck.jsp?type=P&matchInit=tmd"><font color="#003366">上一頁</font></a>
          <%
          }
          if (pagTruck.getPageNo() < pagTruck.getPageSum())
          {
            %>
        <a href="MatchTruck.jsp?type=N&matchInit=tmd"><font color="#003366">下一頁</font></a> <a href="MatchTruck.jsp?type=E&matchInit=tmd"><font color="#003366">最後一頁</font></a>
          <%
          }
          %>
      </div>
...
<%
 if(deliveryRequestNum.trim().length()==0)
  {
 String closePage="MatchTruck.jsp";
 session.setAttribute("closePage",closePage);
%>
<input type="button" name="button" onClick="JavaScript:doPost(1)" value="與送貨要求配對">
<%
 }
 else
  {
