...
if (!webOperator.checkPermission())
  ...
  else
  {
    ...
    Vector userGroup = new Vector(webOperator.getSecurityManager().findUserGroup(userId));
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td><font face="Arial, Helvetica, sans-serif" size="2"><b><font color="#667852">更改用戶組信息</font></b></font></td>
    <td>
...
<form action="UserGroupUpdate.jsp" name="add" method="post">
...
for (int j=0;(!userGroup.isEmpty() && j<userGroup.size());j++)
{
 net.line.fortress.apps.system.security.Group uGroup = (Group)userGroup.get(j);
 String tmpGroupId = uGroup.getGroupID();
 if (tmpGroupId.equalsIgnoreCase(groupId))
     ifInGroup = true;
}
%>
<tr>
  <td><input type="checkbox" <%if (ifInGroup) out.print("checked");%> name="groupId" value="<%=groupId%>"></td>
