...
function doPost(i)
{
  if(i==1)
   {
    ...
    matchUpdate.action="MatchTruck.jsp"
    matchUpdate.submit();
    }
  if(i==2)
   {
    ...
    matchUpdate.action="MatchView.jsp?type=match"
    matchUpdate.submit();
   }
  if(i==3)
  {
  if(!isDate(matchUpdate.deliveryDate.value) && matchUpdate.deliveryDate.value!=0)
   ...
   matchUpdate.action="MatchDelivery.jsp"
   matchUpdate.submit();
  }
}
</SCRIPT>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" height="22" align="left">
  <tr>
    <td width="28%" class="unnamed1">
          ...
          {
            %>
      <div align="left"><a href="MatchDelivery.jsp?type=F&deliveryInit=tmd"><font color="#003366">第一頁</font></a> <a href="MatchDelivery.jsp?type=P&deliveryInit=tmd"><font color="#003366">上一頁</font></a>
          <%
          }
          if (pagDelivery.getPageNo() < pagDelivery.getPageSum())
          {
            %>
        <a href="MatchDelivery.jsp?type=N&deliveryInit=tmd"><font color="#003366">下一頁</font></a> <a href="MatchDelivery.jsp?type=E&deliveryInit=tmd"><font color="#003366">最後一頁</font></a>
          <%
          }
          %>
      </div>
...
<%
 if(truckCapacityNum.trim().length()==0)
  {
 String closePage="MatchDelivery.jsp";
 session.setAttribute("closePage",closePage);
%>
<input type="button" name="button" onClick="JavaScript:doPost(1)" value="與空車配對">
<%
 }
 else
  {
...
<input type="hidden" name="d_change" value="MatchDelivery.jsp">
  </form>
</body>
