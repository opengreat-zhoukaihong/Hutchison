...
<%
  ...
  if (shippingLineBean.shippingLineUpdate(shippingLineData))
    {
    backPageName = "SuccessPage.jsp?backPage=ShippingLineList.jsp&mode=Update";
    dbList.loadShippingLineList();
     }
  else
    backPageName = "ErrorPage.jsp?backPage=ShippingLineList.jsp&mode=Update";
%>
