...
<%@ page import="com.cbtb.web.DbList"%>
...
<p align="right"><a href="TrailerTypeEdit.jsp?trailerId=<%=request.getParameter("trailerId")%>"><font
color="#003366" size="2">更新 </font></a> | <a href="TrailerTypeDelView.jsp?trailerId=<%=request.getParameter("trailerId")%>"><font
color="#003366" size="2">刪除</font></a>  | <a href="javascript:history.back();"><font
